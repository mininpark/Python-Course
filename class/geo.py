...
geolocator = Nominatim(user_agent = 'hpark21@ku.edu.tr') #use your email address
...
locations.append(geolocator.geocode('Istanbul'))
locations.append(geolocator.geocode('Seoul'))
locations.append(geolocator.geocode('Bodrum'))
